...
@HippoEssentialsGenerated(internalName = "breadcrumbdemo:eventsdocument")
@Node(jcrType="breadcrumbdemo:eventsdocument")
public class EventsDocument extends HippoDocument {

    /**
     * The document type of the events document.
     */
    public static final String DOCUMENT_TYPE = "breadcrumbdemo:eventsdocument";
    ...
    private static final String END_DATE = "breadcrumbdemo:enddate";
     ...
     * @return the end date
     */
    @HippoEssentialsGenerated(internalName = "breadcrumbdemo:enddate")
