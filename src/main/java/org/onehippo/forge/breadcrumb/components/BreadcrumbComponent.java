...
public class BreadcrumbComponent extends BaseHstComponent {
	...
	public void doBeforeRender(HstRequest request, HstResponse response)
	    ...
	    request.setAttribute(ATTRIBUTE_NAME, getBreadcrumb(request));
	}
	...
	protected String getSitemenuName(HstRequest request){
	    ...
	    String menuName = this.getParameter(PARAMETER_MENU, request);
	...
	protected String getSeparator(HstRequest request){
	    ...
	    String separator = this.getParameter(PARAMETER_SEPARATOR, request);
